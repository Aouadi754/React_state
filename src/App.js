...
export default class App extends Component {
  constructor(props){
    ...
    this.state={
     Person :{
       FullName:"Mohamed Aouadi",
       Bio:"I am a young Tunisian from the city of beja, I am 25 years old and I like to play ping pong",
  ...
  render() {
    return (
      <div >
           <button style={{marginTop:"55px",backgroundColor:"#C1F4F0",fontSize:"large",fontWeight:"bold",marginLeft:"43%"}} onClick={()=>this.setState({show:!this.state.show})} >Show/Hide the profile</button>
           <br/>
           <br/>
